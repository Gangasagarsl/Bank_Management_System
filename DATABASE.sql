...
create table signup(formno varchar(20),name varchar(20),father_name varchar(20),dob varchar(20),gender varchar(20),email varchar(30),merital_status varchar(20),address varchar(40),city varchar(25),pincode varchar(20),state varchar(20));
show tables;
select * from signup;
...
create table bank(pin varchar(10), date varchar(50),type varchar(100),amount varchar(20));
show tables;
select *from bank;
